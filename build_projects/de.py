...
def build_de_project(project_path, name, target_arch="i686", custom_cflags="", custom_ldflags="", run_make=True):
...
"""
    ...
    if run_make:
        ...
        if result.returncode != 0:
            ...
            return False
        print(f"Başarılı: '{name}.kde' başarıyla derlendi.")
